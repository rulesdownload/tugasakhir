    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 ">
            ...
            <div class="top-0 right-0 px-6 py-4 sm:block">
                    @auth
                    <!-- Settings Dropdown -->
                    <div class="hidden sm:flex sm:items-center sm:ml-6 absolute top-0 right-6 h-16 w-16">
                        <x-dropdown align="right" width="48">
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('adminlogin') }}" class="ml-4 text-sm text-gray-700 underline">Login Admin</a>
                                @endif
                            @endauth
            </div>
                    @endif
